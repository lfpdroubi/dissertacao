...
```
\bcenter
Fonte: O autor, com dados obtidos do FRED [@RHVRUSQ156N; @RRVRUSQ156N].
\ecenter
...
```{r USHOWN, fig.cap = "Proporção da população vivendo em imóveis próprios (EUA)."}
...
```
\bcenter
Fonte: O autor, com dados obtidos do FRED [@RSAHORUSQ156S].
\ecenter
...
```
\bcenter
Fonte: O autor, com dados obtidos do FRED [@RSAHORUSQ156S; @CSUSHPINSA].
\ecenter
