...
variáveis macroeconômicas (*macro variables* ou \gls{MV}) e variáveis do mercado
residencial (*housing market variables* ou \gls{HMV}). Entre as \gls{MV} estão o
\gls{PIB}, a taxa de desemprego, taxa de inflação e entre as \gls{HMV}
encontram-se não apenas os índices de preços, mas também variáveis como o número
de novas residências vendidas, a taxa de vacância e o investimento residencial.
...
exceção do Japão e da Alemanha.
...
papel secundário no aumento do preço dos imóveis.
...
```{r vacancyRate, fig.cap="Home Price Index, de Case e Shiller, em termos reais."}
