...
* como um indicador da estabilidade financeira ou de solidez da exposição ao risco;
...
1. Modelos com variáveis dicotômicas de tempo 
...
2. Modelos de preços característicos
...
c. Método de vendas repetidas (Repeated Sales)
...
d. Métodos baseados em avaliação -- Sales Price Appraisal Ratio (SPAR)
...
foram adotados, a saber, o número de dormitórios e a área de ponderação,
definida pelos critérios do IBGE [@fipezap, 10]. 
