...
mercado, é o ponto onde a oferta e a demanda do mercado são iguais [@varian, p. 310].
...
mercados fortemente restritos [@malaysia] a praticamente infinito (perfeitamente
elástica) em outros mercados. @supplyelasticity argumentam que, no entanto, esta 
...
apresentado nas equações \@ref(eq:flowModel1) a \@ref(eq:flowModel3), onde $Q_S$
...
(usualmente igual a 0,3 [@longrunsupplyelasticity, p. 285]). Assim:
