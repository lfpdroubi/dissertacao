...
@Malpezzi2002TheRO [p. 5] fazem um bom apanhado de diversos conceitos relacionados à 
"especulação". Primeiramente, argumentam que é polêmica a definição do termo
*especulador*, especialmente se comparado ao termo *investidor*: seria o 
...
taxa de desconto [@Malpezzi2002TheRO, 15].
...
[^3]: Expecativas adaptativas assumem que as pessoas presumem que os ganhos 
futuros serão iguais aos do passado recente analisado.
...
Conforme anteriormente mencionado, para @Malpezzi2002TheRO [p. 26], o efeito da
...
### O impacto das variáveis macroeconômicas no preços dos imóveis e formação de bolhas especulativas
...
[^4]: O capítulo \@ref(crise) ilustra como as taxas praticadas no mercado de 
...
acordo com a \@ref(eq:valor-presente) para um imóvel, supondo receita líquida de
