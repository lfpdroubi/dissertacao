...
um desenvolvimento equânime de todo o território.
...
hipotecas *subprime*[^1] nos EUA e se espalhou pelo mundo ainda podem ser
...
habitacional nestes países seja resolvido com a simples emissão de *vouchers*
...
milhões de unidades habitacionais vazias, este número não é muito superior ao
número de pessoas desabrigadas e nem todas estas unidades habitacionais estão
disponíveis, apesar de se encontrarem vazias. Além disto, muitas famílias
ainda vivem em moradias de condições precárias, de maneira que é possível dizer
que a solução para o déficit habitacional dificilmente deixaria de passar pelo
estímulo à construção de novas unidades, seja para a absorver as pessoas 
desabrigadas, seja para melhorar as condições de moradia de boa parte da 
população abrigada.
