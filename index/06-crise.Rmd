...
série de problemas posteriores[^6]

[^6]: Segundo @Malpezzi2002TheRO[p. 2], nas economias mais afetadas,o colapso
...
```{r eff, fig.cap="Taxa efetiva dos fundos federais (FED)"}
ggplot(data = efr, aes(x = date, y = value)) +
  geom_line() +  
  xlab("Ano") +
  ylab("Taxa (a.a.)") +
...
Em alguns países, como nos EUA, as hipotecas são, em sua grande maioria [^7],
...
[^7]: A possibilidade ou não dos devedores terem que arcar com a dúvida
...
### O mercado de securitização de hipotecas

Segundo @simkovic [p. 214-215], o mercado de securitização de hipotecas divide
os empréstimos em quatro diferentes tipos de instituições financeiras: (a) as
instituições especilizadas na **originação**, o passo inicial de conceder
...
ao risco de flutuações de taxas de juros e ao risco de *default* de crédito das
...
e 2003-2004 pode ser explicado pelos fundamentos do mercado [@levitin2012, p.
1182]. Isto se deve, segundo @levitin2012 [p. 1183], porque a securitização
tradicional, que era feita pelas \gls{GSE}, *i.e.* *Fannie Mae* (*Federal
National Mortgage Association*), *Freddie Mac* (*Federal Home Loan Mortgage
Corporation*) e *Ginnie Mae* (*Government National Mortgage Association*),
...
Segundo @levitin2013 [p. 84], entre 2004 e 2008 estas duas bolhas foram geradas
