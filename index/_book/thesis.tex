...
\midrule
\cellcolor{gray!6}{World} & \cellcolor{gray!6}{33,8} & \cellcolor{gray!6}{36,6} & \cellcolor{gray!6}{39,3} & \cellcolor{gray!6}{43,0} & \cellcolor{gray!6}{46,7} & \cellcolor{gray!6}{53,5}\\
...
\cellcolor{gray!6}{Europe} & \cellcolor{gray!6}{57,4} & \cellcolor{gray!6}{63,1} & \cellcolor{gray!6}{67,6} & \cellcolor{gray!6}{69,9} & \cellcolor{gray!6}{71,1} & \cellcolor{gray!6}{73,7}\\
\hspace{1em}Eastern Europe & 48,9 & 56,6 & 63,8 & 68,0 & 68,2 & 69,2\\
\hspace{1em}Western Europe & 68,6 & 72,1 & 73,4 & 74,0 & 76,0 & 79,2\\
\cellcolor{gray!6}{Latin America and the Caribbean} & \cellcolor{gray!6}{49,4} & \cellcolor{gray!6}{57,3} & \cellcolor{gray!6}{64,6} & \cellcolor{gray!6}{70,7} & \cellcolor{gray!6}{75,5} & \cellcolor{gray!6}{79,7}\\
...
\subsubsection{Elasticidade da oferta}\label{elasticidade-da-oferta}}
...
\caption{Preços reais de imóveis e custos de construção nos EUA.}\label{fig:land2}
\end{figure}
\bcenter

\small Fonte -- \textcite[p.~5]{HDT}
\ecenter
...
de demanda no \gls{MI} através da Economia: um choque de demanda acarreta,
inicialmente, um aumento no valor dos aluguéis (\textbf{I}), o que acarreta uma mudança
nos preços dos ativos imobiliários (\textbf{II}), que por sua vez aquece o setor de
construções (\textbf{III}), que finalmente elevará o estoque de imóveis (\textbf{IV}).
\begin{figure}[H]
...
oferta elástica nestes tipos de mercado. Ademais, em alguns mercados, como
...
\hypertarget{regulauxe7uxe3o-do}{%
\section{\texorpdfstring{Regulação do \gls{MI}}{Regulação do }}\label{regulauxe7uxe3o-do}}
...
O custo da regulação de um mercado, segundo \textcite{malpezzi_affordable_2018}, pode ser
entendido pela análise da Figura \ref{fig:externalities}, onde a oferta
privada, \emph{i.e} a oferta que seria disponibilizada ao mercado sem regulação
...
outras tantas \emph{externalidades}.
...
\small Fonte -- Adaptado de \textcite{malpezzi_affordable_2018}.
\ecenter
...
na Figura \ref{fig:regulation-price}, em que \textcite{malpezzi_affordable_2018} plota o
...
alguns \emph{outliers}, nota-se uma correlação relativamente forte entre regulação e
...
\small Fonte -- \textcite{malpezzi_affordable_2018}.
\ecenter

\hypertarget{externalidades}{%
\subsection{Externalidades}\label{externalidades}}

Externalidades são custos que são impostos às partes fora de uma transação
econômica \autocite{malpezzi_affordable_2018}. Entre as possíveis externalidades do
\gls{MI} que causam aumentos dos preços dos imóveis se encontram
\autocite[p.~210-211]{externalities}:
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
...
\item
  Integração racial e;
\item
  Benefícios relacionados a propriedade de um imóvel.
\end{enumerate}
...
Falhas de mercado podem ocorrer devido a\ldots{}
...
\textcite{malpezzi_affordable_2018_1} é válido e interessante para a aplicação em outros
mercados.
...
é um direito (\emph{entitlement}) do cidadão, que ele pode requerer a qualquer
...
Nos EUA, segundo \textcite{malpezzi_affordable_2018_2}, apenas um terço dos cidadãos
...
moradias sociais, de 47\% (\(0,63 \cdot 0,73\)) \autocite{malpezzi_affordable_2018_1}.
...
\caption{Custo regulatório no \gls{MI}.}\label{fig:cohab}
\end{figure}
...
\caption{Custo regulatório no \gls{MI}.}\label{fig:vouchers}
\end{figure}
\bcenter
...
Desta maneira, segundo \textcite{malpezzi_affordable_2018_2}, o parâmetro chave o mercado
...
\textcite{malpezzi_affordable_2018_1}: atuar do lado da da demanda na disponibilização de
...
\hypertarget{instrumentos-de-poluxedtica-de-solo}{%
\section{Instrumentos de política de solo}\label{instrumentos-de-poluxedtica-de-solo}}
