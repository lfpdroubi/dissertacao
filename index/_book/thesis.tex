...
De acordo com \textcite{rangel1986b}, contudo, estudos levados a cabo pelo IPEA
...
\textcite{ADAMS201038} mostrou que, apesar dos bens raízes serem ligados ao mercado
...
mostra que a alta de preços de imóveis nos países estudados por \textcite{ADAMS201038}.
\begin{figure}[H]
...
instalou nestes países desde a crise de 2008 \autocite{berlim,londres,california,suecia,newzeland}.
...
Segundo Greenwood e Hercowitz \autocite[apud][5]{LEUNG}, o estoque de capital imobiliário
...
Davis and Heathcote (2001) \autocite[apud][6]{LEUNG} afirmam que o valor de mercado das
...
imobiliário \autocite[3]{ADAMS201038}.
\begin{figure}[H]
...
no teoricamente no capítulo \ref{historico}, e mostrado por \textcite{ADAMS201038} numa
...
50.451 pontos, quando se iniciou nova tendência de alta,
que perdura até os dias atuais. No momento em que se escreve esta dissertação o
índice se encontra com 212,20 pontos, maior valor da série
...
\textcite{bresser2018}, \textcite{krugman2020}.
\begin{figure}[H]
...
bancário no mercado imobiliário \autocite[148]{Case2000}.
...
fundamentos econômicos que sustentavam os preços \autocite[129]{Case2000}, como parece
ser o caso no momento.

\hypertarget{a-crise-financeira-de-2008}{%
\subsubsection{A crise financeira de 2008}\label{a-crise-financeira-de-2008}}

Segundo \textcite{devil}, a raiz da crise financeira estava nos derivativos de crédito
que transferiam o risco de uma hipoteca dos emprestadores ao mercado financeiro,
ou seja, aos bancos, fundos de \emph{hedge} e companhias seguradoras.
...
\emph{underperform} ou \emph{sell}), assim como o método de Black\&Scholes \autocite{marins2}
