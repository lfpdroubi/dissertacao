...
O \textbf{Capítulo \ref{economia}, {[}O Mercado Imobiliário e a Economia{]}}, aborda os
...
modo, isto é, nas condições de moeda estável, não se fariam\_''. Quer dizer com
...
\chapter{\texorpdfstring{O \glsentrylong{MI} e a Economia}{O  e a Economia}}\label{economia}}
\begin{refsection}
\begin{epigrafe}
    \vspace*{\fill}
    \begin{flushright}
...
\textcite{nagajara2011} adota uma série temporal para cada imóvel, independente do número
de vendas do mesmo imóvel. Um imóvel com apenas uma venda, apresentará uma
série temporar de valor único. Assim, o método incorpora também vendas de
imóveis isoladas, aproveitando melhor os dados. Além disto, são utilizadas
informações de localização (código postal) dos imóveis, o que conduz a um
melhor poder de predição de valores com a utilização do índice, se comparado aos
outros índices de vendas repetidas existentes.
...
hipótese não assumida no método de \textcite{bailey1963}. Assim, \textcite{Case1989}\ldots{}
