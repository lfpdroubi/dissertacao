...
Afirmações como estas acerca do imposto sobre a propriedade são comuns e se
baseiam na "visão antiga" (*old view*) ou tradicional do imposto que, de acordo
com @oates2016, é baseada num modelo de equilíbrio parcial proposto por @simon e
@netzer, em que a hipótese principal é a de que o retorno sobre o capital é
constante em todo o território. Assim, o capital migraria no longo prazo para as
jurisdições em que o retorno líquido do capital sobre os imóveis se igualaria ao
retorno líquido do capital em termos nacionais. Desta forma, o imposto sobre a 
propriedade pode ser dividido em duas partes, uma aplicável sobre a terra e a 
outra aplicável sobre as estruturas. Segundo esta teoria, parte do valor das 
obrigações tributárias presentes e futuras relacionadas ao valor da terra é 
capitalizada no próprio preço da terra (isto é, o ônus do imposto sobre o valor
da terra é absorvido pelos proprietários da terra), já que sua oferta é 
inelástica, enquanto que as obrigações incidentes sobre o valor das estruturas 
devem ser absorvidas pelos consumidores finais dos imóveis, dado que a oferta de
capital é elástica.

Existem outras visões sobre o imposto sobre a propriedade imobiliária, contudo.
Em uma delas, a *benefit view*, desenvolvida por @hamilton1975 [@hamilton1976a; 
@hamilton1976b] sobre o modelo de @tiebout o imposto sobre a propriedade é visto 
como uma espécie de taxa (*fee*) paga em troca de serviços prestados pela 
municipalidade, o que altera completamente a percepção dos contribuintes quanto 
ao ônus do imposto.
  
Nos \gls{EUA}, por exemplo, ou em grande parte dos \gls{EUA} o imposto sobre a
propriedade pode virtualmente ser visto como uma taxa (*fee*) paga em
contrapartida pela prestação de serviços educacionais por parte da
municipalidade: como os recursos da *property tax* nos \gls{EUA} são utilizados
...
uma taxa pela prestação destes serviços educacionais, ou seja, o ônus do imposto
sobre a propriedade é nulo na percepção dos contribuintes americanos
[@fischel1989, p. 468; @fischel2013, p. 20].
...
Uma terceira abordagem, a respeito do imposto sobre a propriedade, a 
*capital view*, advém do trabalho seminal de @mieszkowski, segundo o qual como o 
imposto sobre a propriedade é cobrado com maior ou menor intensidade em todas as 
municipalidades, fazendo com que o capital, suposto perfeitamente móvel entre as 
jurisdições, migre dos municípios de mais altas alíquotas para os de mais baixas 
alíquotas, causando assim uma má-alocação do capital. Segundo esta teoria, a 
...
ou negativamente sobre o consumo de bens imóveis. Segundo @zodrow2001, de acordo 
...
que os municípios com baixas alíquotas contariam com preços de imóveis e 
...
De acordo com @oeates2016, uma síntese das duas últimas abordagens pode ser
encontrada em @lutz. Segundo @oeates2016, ao observar os efeitos de uma redução
...
habitação. Segundo @oeates2016, isto sugere que a "benefit view" do imposto 
